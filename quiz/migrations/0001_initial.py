# Generated by Django 2.1 on 2019-10-12 12:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_type', models.CharField(choices=[(1, 'input'), (2, 'select')], default='select', max_length=6)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authority', models.BooleanField(default='user', max_length=5)),
